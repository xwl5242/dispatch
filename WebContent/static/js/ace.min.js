...
$(function(){
	 ...
	 $(".advanced-btn").bind("click",function(){
		
		 var inputHelp=$(".advanced-moreInput").val();
		 
		 if(inputHelp==undefined){
			    $(".search-form").append("<input type='hidden' value='0' class='advanced-moreInput'/>")
			    inputHelp=$(".advanced-moreInput").val();
		 }
		 if(inputHelp=="0"){
	        	$(".search-more-hidden").show();
	        	$(".advanced-moreInput").val("1");
	     }else if(inputHelp=="1"){
	        	$(".search-more-hidden").hide();
	        	$(".advanced-moreInput").val("0");
	     } 
