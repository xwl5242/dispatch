...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			$("#"+$.jgrid.jqID(pgid) )
			.append("<div id='"+pgcnt+"' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr></td><td id='"+cent+"' align='left' style='white-space:pre;'></td><td id='"+rgt+"' align='right'></td></tr></tbody></table></div>")
...
$.jgrid.extend({
	...
	setGroupHeaders : function ( o ) {
		...
		return this.each(function(){
			...
			$("#resultList_cb",$theadInTable).css("width","20px");
			//liuzijian
        ...
        excelExport : function(o) {
            ...
            return this.each(function(){
                ...
                if(o.exptype == "remote") {
                    ...
                    url=o.url;
                    colsName=o.colsName;
                    colsLable=o.colsLable
                    var form = $("<form></form>");
					form.attr('action',url);
					form.attr('method','post');
					var inputPd;
                    for(var pd in pdata){
                    	inputPd = $("<input type='hidden' name='"+pd+"' />");
                    	inputPd.attr('value',pdata[pd]);
                    	form.append(inputPd);
                    }
                    var input1 = $("<input type='hidden' name='colsName' />");
					input1.attr('value',colsName);
					var input2 = $("<input type='hidden' name='colsLable' />");
					input2.attr('value',colsLable);
					form.append(input1);
					form.append(input2);
					form.appendTo("body");
