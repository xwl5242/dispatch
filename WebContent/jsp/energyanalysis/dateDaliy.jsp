...
<table id='a' cellpadding="0" cellspacing="0" width="100%" align="left" >  
		<tr align="left" >
			...
			<td  width="25%" align="left">
				<input id='startTimeBox' name="startTimeBox" style="width:120px" class="easyui-datebox" />
				<input type="hidden" id='startTime' name="startTime" value="<%=startTime%>" style="width:100%" />
				~<input id='endTimeBox' name="endTimeBox"  width="5%" style="width:120px" class="easyui-datebox" />
				<input type="hidden" id='endTime' name="endTime" value="<%=endTime%>" style="width:100%" />
			</td>   
...
<report:html name="report1" reportFileName="datedaliy.raq" needPageMark=""
