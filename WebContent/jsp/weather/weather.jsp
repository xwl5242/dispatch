...
$(document).ready(function(){
	       	    ...
	       	    series : [
	       	        {
	       	            name:'最大气温',
	       	            type:'line',
	       	            data:[2,2,2,3,3,6,6,9,9,10,11,12,12,14,12,10,6,6,5,5,5,3,2,2],
	       	        ...
	       	        },
	       	        {
	       	            name:'平均气温',
	       	            type:'line',
	       	            data:[1,1,1,2,2,5,5,8,8,9,10,11,11,13,11,9,5,5,4,4,4,2,1,1],
	       	            itemStyle:{normal:{label:{show:true}}},
	       	            markLine : {
	       	                data : [
	       	                    {type : 'average', name : '平均值'}
	       	        ...
	       	        },
	       	        {
	       	            name:'最小气温',
	       	            type:'line',
	       	            data:[0,0,0,1,1,4,4,7,7,8,9,10,10,12,10,8,4,4,3,3,3,1,0,0],
	       	            itemStyle:{normal:{label:{show:true}}},
	       	            markLine : {
	       	                data : [
	       	                    {type : 'average', name : '平均值'}
    ...
    $table.bootstrapTable({
        height: divH-60,
        method: 'post',
        url: "<%=path %>/jsp/weather/weatherJson.json",
        dataType: "json",
        striped: true,
        pagination: false,
