...
<div id="tab_menu" style="height:30px;background: #d8e4f3;" >
...
<div id="tab_item" class="menu_box" style="display:none;width:100px;height:96px;">
		<div class="menu_line"></div>
        <div class="menu_item" id="mm-refresh"  onclick="refreshTab()" >
              	<div class="menu_item_text">刷新</div>
        </div>
		<div class="menu_item" id="mm-tabclose" onclick="closeTab()">
				<div class="menu_item_text">关闭</div>
		</div>
		<div class="menu_item" id="mm-tabcloseall" onclick="closeAllTab()">
		    	<div class="menu_item_text"> 关闭全部</div>
		</div>
		<div class="menu_item" id="mm-tabcloseother" onclick="closeOtherTab()">
		    	<div class="menu_item_text">关闭其他</div>
		</div>
</div>
<div id="tab_shadow" class="menu_shadow" style="display:none;width:102px;">

</div>
 
<div style="width:100%;">
	<div id="page" style="width:100%;height:100%;margin-top: 5px;"></div>
</div>		
</body>
<script type="text/javascript">
...
//var url=$("#rightUrl",parent.document).val()==""?"/login/systemHome.do":$("#rightUrl",parent.document).val();

var url="/login/systemHome.do";

var index_url="<%=path%>"+url;
...
$( function() {
	...
	<%--  tab.add( {
			id :'tab1_index2',
			title :"主页",
			url :'<%=path%>/jsp/sys/admin/home1.jsp',
			isClosed :false
		}); --%>
	...
	TabView.prototype.menuItem=function(menuid,title,url){
	         		...
	         		var menu=$("#"+menuid)
					  menu.bind("contextmenu",function(){ 
						    ...
						    $("#tab_item").css({"top":e.pageY,"left":e.pageX})
						    $("#tab_shadow").css({"top":e.pageY,"left":e.pageX})
					        $("#tab_item").show();
						    $("#tab_shadow").show();
